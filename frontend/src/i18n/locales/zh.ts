export default {
  ...
  admin: {
    ...
    proxies: {
      ...
      expiresAt: '到期时间',
      nDays: '{days} 天',
      expiryDaysPlaceholder: '输入天数后自动计算到期日期',
      fallbackMode: '到期后处理',
      fallbackNone: '不处理',
    ...
    settings: {
      ...
      subscriptionExpiryNotify: {
        title: '订阅到期提醒',
        description: '在用户订阅即将到期时发送邮件提醒',
        enabled: '启用订阅到期提醒',
        enabledHint: '开启后将按后台任务计划发送到期提醒邮件'
      },
      emailTemplates: {
        title: '邮件模板',
        description: '编辑验证码、密码重置、订阅和余额提醒等系统邮件内容',
        preview: '刷新预览',
        previewing: '预览中...',
        ...
        placeholders: '可用变量',
        placeholdersHelp: '点击变量可复制到剪贴板，发送时会自动替换为真实值。',
        livePreview: '实时预览',
        noPreview: '暂无预览',
        customized: '已自定义',
        previewSecurityHint: '预览在隔离沙箱中渲染，仅用于检查模板外观。',
        validationRequired: '请填写邮件主题和 HTML 内容',
        saveSuccess: '邮件模板已保存',
        restoreConfirm: '确定要恢复为官方默认模板吗？当前自定义内容会被覆盖。',
        restoreSuccess: '已恢复官方默认模板',
  ...
  version: {
    ...
    customDeployRequired: '使用自定义镜像发布',
    customDeployHint:
      '已保留新版提醒；NavToAI 生产环境请使用 fork 构建的镜像或二进制升级，不要使用官方后台更新或回滚。'
  },
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 NavtoAI API',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">NavtoAI API 是一个强大的 AI 服务中转平台，让您轻松管理和分发 AI 服务。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 NavtoAI API 的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 NavtoAI API',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 NavtoAI API AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
